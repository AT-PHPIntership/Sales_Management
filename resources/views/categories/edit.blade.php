@extends('layouts.app')
@section('page-title')
@lang('categories.edit.title', [
    'category' => $category->name
])
@endsection

@section('section-title')
    @lang('categories.edit.section-title', [
        'category' => $category->name
    ])
@endsection
...
@section('page-content')
    <div class="x_content">
        <form class="form-horizontal form-label-left" role="form" method="POST" action="{{ action('CategoryController@update', ['category' => $category->id]) }}">
            {{ csrf_field() }}
            {{ method_field('PATCH') }}
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="name" type="text" name="name" value="{{ $category->name }}" data-validate-length-range="1,50" class="form-control col-md-7 col-xs-12" required="required">
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea id="description" name="description" rows="5" class="form-control col-md-7 col-xs-12">{{ $category->description }}</textarea>
              </div>
            </div>

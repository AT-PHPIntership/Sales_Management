        ...
        <form id="date-selector" action="{{ route('statistic.monthly') }}" method="get">
          <div class="form-group">
              <div class="input-group">
                <input name="date-picker" id="selected-month-year" class="form-control date-picker form-control has-feedback-left" title="@lang('statistics.title_select_date')" 
              ...
              <tr>
                ...
                <th>
                  ...
                  <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                    <p class="">@lang('statistics.label_percentage')</p>
                  </div>
                </th>
              </tr>
              <tr>
                  ...
                  <table class="tile_info">
                    @foreach ($topProducts->take(\Config::get('common.TOP_4')) as $topProduct)
                      <tr>
                        ...
                        <td>
                          {{ ceil(($topProduct->sum('amount') * \Config::get('common.ONE_HUNDRED')) / $total_amount) }}@lang('statistics.percentage')
                        </td>
                        <?php
                    ...
                    <tr>
                      <td>
                        <p><i class="fa fa-square {{ $color[$i++] }}"></i>@lang('statistics.label_other') </p>
                      </td>
                      <td>{{ \Config::get('common.ONE_HUNDRED') - $subtractHotProduct }}@lang('statistics.percentage')</td>
                    </tr>
                  </table>
                </td>
              </tr>
...
@push('end-page-scripts')
  ...
  <script type="text/javascript">
    var months = [
      "@lang('statistics.label_january')",
      "@lang('statistics.label_february')",
      "@lang('statistics.label_march')",
      "@lang('statistics.label_april')",
      "@lang('statistics.label_may')",
      "@lang('statistics.label_july')",
      "@lang('statistics.label_june')",
      "@lang('statistics.label_august')",
      "@lang('statistics.label_september')",
      "@lang('statistics.label_october')",
      "@lang('statistics.label_november')",
      "@lang('statistics.label_december')",
    ];
    ...
    labels.push("@lang('statistics.label_other')");
    var data = [
      @foreach ($topProducts->take(\Config::get('common.TOP_4')) as $topProduct)
